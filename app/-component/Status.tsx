    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center space-y-6">
          ...
          <p className="font-mono text-purple-400 text-lg animate-pulse">
    ...
    return (
      <div className="flex items-center justify-center min-h-[50vh] ">
        <div className="text-center space-y-4">
          <FaBug className="mx-auto text-6xl text-red-500 animate-pulse" />
          <h2 className="text-2xl md:text-3xl font-bold text-red-500 font-mono">
            اوه! خطایی رخ داد
          </h2>
          <p className="text-gray-400 font-mono">{message || "لطفاً دوباره تلاش کنید."}</p>
        </div>
      </div>
    );
  }
